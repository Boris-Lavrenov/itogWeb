...
<template>
	<div class="app">
        ...
        <div v-if="url === 'dfo' || url === 'imvd'" style="text-align: justify; text-indent: 2rem">
            ...
            2024 год для получения общего высшего образования и пунктом 27 Порядка приема в учреждение образования «Могилевский институт Министерства внутренних дел
            Республики Беларусь» на 2024 год для получения общего высшего образования, при подаче заявления в межвузовскую приемную комиссию абитуриент указывает
